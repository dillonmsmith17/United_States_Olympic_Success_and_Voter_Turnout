...
winter_lm <- glm(percent ~ gold_percent + gold_change + medal_percent + total_change, 
                 data = winter_joined)
# create linear model for change in percent 
winter_lm_change <- glm(percent_change ~ gold_percent + gold_change + medal_percent + total_change, 
                        data = winter_joined)
 
# create linear model for percent 
summer_lm <- glm(percent ~ gold_percent + gold_change + medal_percent + total_change, 
                 data = summer_joined)
# create linear model for change in percent 
summer_lm_change <- glm(percent_change ~ gold_percent + gold_change + medal_percent + total_change, 
                        data = summer_joined)
```
